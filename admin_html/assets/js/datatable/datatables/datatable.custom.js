$(document).ready(function () {
    ...
    $('#basic-1').DataTable({
        "oLanguage": {
            "sInfo": "Toplam: _TOTAL_ sonuç bulundu.",
            "sInfoEmpty": "Aramanıza uygun ürün bulamadık.",
            "sEmptyTable": "Aramanıza uygun ürün bulamadık.",
            "sInfoFiltered": " (_MAX_ ürün filtrelendi.)",
            "sSearch": "Ara:",
            "sLengthMenu": " Her sayfada _MENU_ ürün göster.",
            "oPaginate": {
                "sPrevious": "Geri",
                "sNext": "İleri"
            }
